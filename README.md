# Replace README.md with a clean version
echo "# powerbi-analytics-project
...
## Notes:
- This repo provides a scaffold and examples. Replace placeholders with production credentials and robust error handling before using in production." > README.md